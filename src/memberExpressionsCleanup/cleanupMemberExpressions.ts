...
export const cleanupMemberExpressions = (ast: File, globalState: GlobalState) => {
  utils.runVisitors(ast, globalState, RESTORE_GLOBAL_REFERENCES, REPLACE_WITH_LITERALS, REPLACE_UNARY_AND_BINARY);
  return ast;
};
